...
const SearchResults: React.FC<Props> = ({ postalCode, streetName, streetNumber, suffix, team, apiName }) => {
  ...
  const apiVersion = apiName === "ZKS" || teamSettings?.use_zaken_backend ? "v2" : "v1"
