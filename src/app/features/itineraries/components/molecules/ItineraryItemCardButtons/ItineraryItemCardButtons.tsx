...
import DeleteItineraryItemButton
  from "app/features/itineraries/components/molecules/DeleteItineraryItemButton/DeleteItineraryItemButton"
  ...
  <>
    <Spacing pb={ 2 }>
      <Button variant="secondary"
              onClick={ () => navigate(to("/visit/:itineraryId/:caseId", { caseId, itineraryId })) }>Bezoek</Button>
    </Spacing>
    <Spacing pb={ 2 }>
